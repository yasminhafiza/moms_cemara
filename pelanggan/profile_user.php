...
// Query untuk mengambil data pengguna dan foto berdasarkan ID pengguna
...
<body>
  ...
  <nav
    ...
    <div
      ...
      <a href="../index.php" class="hover:text-gray-300 text-sm lg:text-base">Beranda</a>
      <a href="../index.php#menu-section" class="hover:text-gray-300 text-sm lg:text-base">Menu</a>
      <a href="../index.php#promo-section" class="hover:text-gray-300 text-sm lg:text-base">Promo</a>
    ...
    <div
      ...
      <div class="flex flex-col space-y-4 text-white">
        ...
        <div class="flex flex-col items-center mb-4">
          ...
          <p class="text-lg font-medium text-black"><?php echo htmlspecialchars($user['nama']); ?></p>
        </div>
        ...
        <nav>
          <ul class="flex flex-col space-y-3">
            <li>
              <a
                href="../pelanggan/edit_profil.php"
                class="block p-2 rounded-md text-black text-center hover:bg-[#B6EADD]">Edit Profil</a>
            </li>
            <li>
              <a
                href="../pelanggan/pesanan.php"
                class="block p-2 rounded-md text-black text-center hover:bg-[#B6EADD]">Pesanan Saya</a>
            </li>
            <li>
              <a
                href="../pelanggan/hapus_akun.php"
                class="block p-2 rounded-md text-black text-center hover:bg-[#B6EADD]">Hapus Akun</a>
            </li>
            <li>
            ...
            <li>
              <a
                href="../index.php"
                class="block text-black text-center hover:text-black">Beranda</a>
            </li>
            <li>
              <a
                href="../index.php#menu-section"
                class="block text-black text-center hover:text-black">Menu</a>
            </li>
            <li>
              <a
                href="../index.php#promo-section"
                class="block text-black text-center hover:text-black">Promo</a>
            </li>
            <li>
              <button
  ...
  <div class="bg-[#B6EADD] min-h-screen flex flex-col lg:flex-row">
        ...
        <nav class="mt-6 lg:mt-2">
          <ul
            ...
            <li class="mb-3 w-full sm:w-auto">
              <a
                href="../pelanggan/edit_profil.php"
                class="block p-2 rounded-md hover:bg-[#B6EADD] active:bg-[#B6EADD] w-full text-black text-center lg:text-left">Edit Profil</a>
            </li>
            <li class="mb-3 w-full sm:w-auto">
              <a
                href="../pelanggan/pesanan.php"
                class="block p-2 rounded-md hover:bg-[#B6EADD] active:bg-[#B6EADD] w-full text-center lg:text-left">Pesanan Saya</a>
            </li>
            <li class="w-full sm:w-auto">
              <a
                href="../pelanggan/hapus_akun.php"
                class="block p-2 rounded-md hover:bg-[#B6EADD] active:bg-[#B6EADD] w-full text-center lg:text-left">Hapus Akun</a>
            </li>
          </ul>
        </nav>
      </div>
    ...
    <!-- Main Content -->
    <div class="w-full mt-32 sm:mt-32 md:mt-32 lg:w-3/4 p-4 lg:p-8 lg:mt-32 lg:ml-[5%]">
      <div class="shadow rounded-md p-4 lg:p-6 bg-gray-300/50 backdrop-blur-md max-w-3xl mx-auto">
        <h1 class="text-xl font-bold mb-6 text-center lg:text-left lg:ml-20">Data Pengguna</h1>

        <div class="flex flex-col lg:flex-row gap-8 mx-4 lg:mx-14">
          <div class="flex flex-col items-center">
            <img src="../assets/foto/avatar.png" alt="Edit Profil"
              class="rounded-full mb-4 w-24 h-24 lg:w-36 lg:h-36" />
            <!-- <button class="text-blue-500 underline">Ubah Foto</button> -->
          </div>

          <form action="update_profile.php" method="POST" class="space-y-4 w-full lg:w-2/3 lg:ml-auto">
            <div>
            ...
            <div>
              <label for="telepon" class="block text-gray-700">Nomor Telepon</label>
              <input
                type="text"
                id="telepon"
                name="telepon"
                value="<?php echo htmlspecialchars($user['phone_number']); ?>" readonly
                class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
