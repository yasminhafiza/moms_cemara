...
<head>
  ...
  <script>
    ...
    function login(e) {
      ...
      // Ubah tampilan menu setelah login
      toggleNav(true);
    }

    // Fungsi untuk menampilkan/menyembunyikan menu berdasarkan status login
...
<body>
  ...
  <nav
    ...
    <div
      ...
      <a href="login.php">
        <button
          class="px-3 py-1.5 lg:px-4 lg:py-2 border border-white text-white rounded-lg hover:bg-white hover:text-gray-800 transition text-sm lg:text-base">
          Masuk
        </button>
      </a>
    </div>
    ...
    <div
      ...
      <div class="flex flex-col space-y-4 text-white">
        <a href="login.php" class="text-center">
          <button
            class="px-3 py-1.5 border border-white text-white rounded-lg hover:bg-white hover:text-gray-800 transition">
            Masuk
          </button>
        </a>
      </div>
  ...
  <!-- Promo Section -->
  <div class="bg-[#FFE0EB] px-4 sm:px-6 md:px-8 lg:px-12 py-8 md:py-12">
      ...
      <div class="bg-[#BFE7E0] rounded-lg shadow-md p-4 sm:p-6 md:p-8 mb-6">
        ...
        <div
          ...
          <div
            ...
            <span class="text-pink-500 font-bold w-full text-center">FREE!</span>
            <span class="w-4/5 text-center">1 Jar Strawberry Short Cake (100ml)</span>
            <span class="w-3/5 text-center">Khusus Pemesanan tanggal</span>
            <span class="w-2/5 text-center font-semibold">22-25 Desember</span>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <iframe
            ...
            class="w-full rounded-md"></iframe>
        </div>
      </div>
